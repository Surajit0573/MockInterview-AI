...
const Home = () => {
  return (
    <div className="relative min-h-screen font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gradient-to-r from-blue-600 to-blue-800 rounded-full flex items-center justify-center transform hover:scale-105 transition-transform duration-300">
            ...
            <div className="hidden md:flex items-center space-x-8">
              {["Home", "About", "Services", "Contact"].map((link) => (
                <a
                  ...
                  className="text-gray-600 hover:text-blue-600 transition-colors duration-300 text-sm uppercase tracking-wider"
                >
                  {link}
                </a>
              ))}
              <Button
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg transform hover:scale-105 transition-all duration-300"
              >
                Get Started
              </Button>
            </div>
      ...
      {/* Hero Section */}
      <section className="relative px-4 py-20 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-gray-900 leading-tight mb-8">
              Ace Your Next
              <br />
            ...
            <p className="mt-4 text-lg sm:text-xl lg:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
      ...
      <div className="container mx-auto px-6 py-16 text-center">
        <h5 className="text-teal-400 font-semibold uppercase mb-4">Tailored Preparation</h5>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Feature 1 */}
          <div className="bg-blue-100 p-6 rounded-lg text-gray-800 shadow-md">
          ...
          <div className="bg-blue-100 p-6 rounded-lg text-gray-800 shadow-md">
            ...
            <h3 className="text-lg font-semibold mb-2">Realistic Experience</h3>
            <p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-xl text-gray-600">Comprehensive interview preparation tools at your fingertips</p>
          </div>
      ...
      <section className="py-20 bg-blue-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-xl text-gray-600">Take the first step towards interview success</p>
          </div>
